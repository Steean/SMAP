 ...
 * lead to a {@link ContentActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link MenuFragment} and the item details
 * (if present) is a {@link ContentFragment}.
 * <p>
...
public class MainActivity extends FragmentActivity
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            arguments.putString(ContentFragment.ARG_ITEM_ID, id);
            ...
            detailIntent.putExtra(ContentFragment.ARG_ITEM_ID, id);
